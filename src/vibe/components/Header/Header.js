      ...
      <header className="app-header">
        ...
        <div className="top-nav">
          <Navbar color="faded" light expand="md">
            ...
            />
            <div className="page-heading "> <span className="bold pl-1">Local</span>  {"  "} <Clock format={'HH:mm:ss'} ticking={true} /> {" "}  <span className="bold pl-5 ">Deterlab</span>  {"  "}  <Clock format={'HH:mm:ss'} ticking={true} timezone={'US/Pacific'} /></div>
